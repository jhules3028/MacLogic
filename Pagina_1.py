...
def Pagina_principal(page: ft.Page):
        ...
        ft.Container(
            ft.Column(
                [
                    ...
                    Nota,
                    ft.Row([ft.Text("Materia:  "), materias, ft.Text("               ¿Es importante? "),
                            marcador_importancia]),
                    ft.Row([
                        ...
                        ft.ElevatedButton("Guardar Nota y hacer una nueva", icon=ft.icons.SAVE_ROUNDED,
                                          on_click=confirmar_nota_guardada)]),
    ...
    contenido_informativo = ft.Container(
        content=ft.Column(
            controls=[Noticias_Importantes, Hackatones, Competencias_matematicas, Deportes, texto_botones, botones]))
    ...
    def Completar_evento(e, contenido):
        ...
        with open('Notas_normales.txt', 'w') as file:
            ...
            Lista_pendientes.controls.clear()
            Lista_pendientes.controls.extend(construir_lista(pendientes))
            Lista_pendientes.update()
    ...
    def Completar_evento_importante(e, contenido):
        ...
        with open('Notas_importantes.txt', 'w') as file:
            ...
            Lista_pendientes_importante.controls.clear()
            Lista_pendientes_importante.controls.extend(construir_lista_importante(pendientes))
            Lista_pendientes_importante.update()
